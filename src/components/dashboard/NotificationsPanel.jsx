function NotificationsPanel() {
  const notifications = [
    { icon: "MSG", title: "New message", description: "From your account manager", time: "5 min ago", unread: true },
    { icon: "UPD", title: "Product update available", description: "MITRA NIDHI CHITI PRO v2.1.0", time: "1 hour ago", unread: true },
    { icon: "SYS", title: "System maintenance", description: "Scheduled for tomorrow at 2 AM", time: "3 hours ago", unread: false },
  ];
        ...
        {notifications.map((notif, idx) => (
          ...
          >
            <div style={{ display: "flex", gap: 10 }}>
              <span style={{ fontSize: 12, fontWeight: 800 }}>{notif.icon}</span>
              <div style={{ flex: 1 }}>
