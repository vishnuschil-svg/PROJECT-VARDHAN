    ...
    <div className="card solid">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        <div style={{
          ...
          <p style={{ fontSize: 12, fontWeight: 600, color: "var(--info-color)", margin: 0, marginBottom: 4 }}>
            ℹ️ Documentation
          </p>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, fontWeight: 600, color: "var(--success-color)", margin: 0, marginBottom: 4 }}>
            ✓ Support Tickets
          </p>
          <p style={{ fontSize: 11, color: "var(--text-tertiary)", margin: 0 }}>
