...
function Dividends() {
  const columns = [
    ...
    { key: "dividend_amount", label: "Dividend", width: "130px", render: (val) => `₹${val.toLocaleString()}` },
    { key: "calculation_basis", label: "Basis", width: "130px", render: (val) => val.replace(/_/g, " ") },
    { key: "dividend_date", label: "Date", width: "120px", render: (val) => new Date(val).toLocaleDateString() },
